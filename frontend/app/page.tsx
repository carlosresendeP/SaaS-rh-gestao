    ...
    <div className="bg-background text-foreground antialiased min-h-screen">
      ...
      <main className="w-full max-w-[1440px] mx-auto overflow-hidden">
        ...
        <section className="px-6 py-16 mt-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            {VALUE_CARDS.map((card) => (
              ...
              >
                <div
                  className={`w-14 h-14 rounded-full ${card.iconBg} flex items-center justify-center`}
                >
        ...
        <section className="px-6 py-16 grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
          ...
          <div className="order-1 lg:order-2 flex flex-col gap-5">
            ...
            <p className="text-lg text-muted-foreground leading-relaxed">
              Nossa plataforma processa milhares de pontos de dados para gerar
              um{" "}
              <strong className="text-foreground">Score de Alinhamento</strong>{" "}
              holístico. Avaliamos não apenas a stack tecnológica, mas traços
              comportamentais, aderência aos ritos da empresa e potencial de
              liderança através da metodologia DISC integrada.
            </p>
        ...
        <section className="px-6 py-16 mt-4 mb-16 max-w-3xl mx-auto text-center">
          <div className="bg-card border border-border rounded-2xl p-10 shadow-sm flex flex-col justify-center items-center gap-6">
